...
def main():
    ...
    parser.add_argument(
        ...
        "--algorithm",
        type=str,
        choices=["wlstsq-lm", "fcekf", "hcmci", "ccekf", "cnkkt"],
        help="Navigation algorithm to simulate (wlstsq-lm for WLSTSQ-LM, fcekf for FCEKF, hcmci for HCMCI, ccekf for CCEKF, or cnkkt for CNKKT)",
    )
    parser.add_argument(
        "-M",
        "--monte-carlo-sims",
