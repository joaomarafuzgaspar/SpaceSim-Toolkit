...
class AtmosphericModel:
    ...
    def __init__(self):
        ...
        self.rho_0 = (
            ...
            * 1e9
        )  # Reference density [kg / m^3] -> [kg / km^3]
    ...
    def get_rho(self, h):
        ...
        Parameters:
        h (float): The altitude in km.

        Returns:
        float: The atmospheric density in kg / km^3.
        """
        # Find the index of the closest below altitude
        idx = 27 if h >= 1000 else np.argmax(h < self.h_0) - 2
    ...
    def get_H(self, h):
        ...
        Returns:
        float: The atmospheric scale height in km.
        """
        # Find the index of the closest below altitude
        idx = 27 if h >= 1000 else np.argmax(h < self.h_0) - 2
